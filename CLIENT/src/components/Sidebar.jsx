...
function Sidebar() {
  ...
  return (
    <div className="sidebar">
        ...
        {((userType == "OPERATOR")) &&<NavLink to="/billing-area" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {(userType == "ADMIN") &&<NavLink to="/support-admins" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "ADMIN") || (userType == "SUPPORTADMIN")) &&<NavLink to="/companies" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "ADMIN") || (userType == "SUPPORTADMIN") || (userType == "COMPANY")) &&<NavLink to="/operators" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "ADMIN") || (userType == "SUPPORTADMIN")) &&<NavLink to="/categories" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "OPERATOR")) &&<NavLink to="/add-stock" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/stocks" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/manage-stock" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/manage-bills" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {/* {((userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/manage-installation" className={({ isActive }) => (isActive ? 'active' : '')}>
          ...
          </svg> Manage Installation
        </NavLink>} */}
        {((userType == "COMPANY")) &&<NavLink to="/customize-bill" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/customize-add-stock" className={({ isActive }) => (isActive ? 'active' : '')}>
          ...
          </svg> Customize Add Stock
        </NavLink>}
        {/* {((userType == "COMPANY")) &&<NavLink to="/installation-teams" className={({ isActive }) => (isActive ? 'active' : '')}>
          ...
          </svg> Installation Teams
        </NavLink>} */}
        {((userType == "ADMIN") || (userType == "SUPPORTADMIN") || (userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/items" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/sellers" className={({ isActive }) => (isActive ? 'active' : '')}>
        ...
        {((userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/buyers" className={({ isActive }) => (isActive ? 'active' : '')}>
