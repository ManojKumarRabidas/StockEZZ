...
function Sidebar() {
  ...
  return (
    <div className="sidebar">
        ...
        {((userType == "COMPANY") || (userType == "OPERATOR")) &&<NavLink to="/stock-details" className={({ isActive }) => (isActive ? 'active' : '')}>Stock Details</NavLink>}
        ...
        {((userType == "COMPANY")) &&<NavLink to="/customize-add-stock" className={({ isActive }) => (isActive ? 'active' : '')}>Customize Add Stock</NavLink>}
